...
action it self is based on the nature of non-caltivating. 
...
https://bux.bracu.ac.bd/courses/course-v1:buX+CSE371+2020_Fall/about
...
## ==Storyes/Life recored== / Great story - Dec 23
when you stop giving a fack about the noise you can actually focus on the things that matter, your goals, your values and the people who actually deserve your time. You already know what you value deep down. the problem is you keep letting nonsense distract you.
And you don't need external approval to know your worth. If it's not a hell yeah it's a no.
Confidence is magnetic, clearity is rare.
init-solu is storgne, so those failures won't paralyze you, you'll learn adapt, and keep moving forward.
Your time and engergy are precious stop giving them away to things that don't matter.

## ==Storyes/Life recored== / Great story - Dec 23
- Surah Al Baqarah | urdu translation - https://www.youtube.com/watch?v=d4mZ-uBwp10&list=PL1GfR-XLosj1p34MxHsdGhSgFOegiT9k3&index=2
     4:06 8:30-8:52
     I'll start at 10:17

- What is programming (my take away is)
      tech yourself to code reall it comes down to doing it, like almost everything.
      Don't write algorithms like binary search algorithms.
      most software engineers are basicallly Translators.
      Translate: "Business Requirement" -> into "Code".
      CRUD apps, you basically creating an app that looks like create delete update read.
      Frontend = View
      Business Logic = Controller
      Database = Model
      in practice you are translating really a sittey language (business requirement) to some what code.
      this is what you will leanr in bootcamps.
      in coma, you don't do this, nothing in coma looks like this stupde paradime. And this is the thing that is pretty soon replease by AIs.
        1. Build a CRUD app for contracting firm
        2. Record all the inputs of my developers (translators)
        3. Train AI model to translate "Business Logic" -> to "Code"
      It's really trash work. (unproductive) It's kind a trash.
      They don't know nothing about computer, what they know about is basically how to translate this sittey language into "someone elses code using, find, copy, pase". It's just mamorizing how many things you have, mamorizing sintax of something stuped.
      I come from hacking background. input -> system -> output. what input to the system achieves my desired outcome? there are pure fuction, pure model. Figuring out how to make the function behave how you want.
      good at hacking, you just need to practice this basic idea. or this is just pattern recongnition problem. Once you can dreel, it's no longer a tesk of intelitionce it's a task of are willing to put practice 40h a week into leanring. it's leaning and applying new skill, so repetition it's all about.
      High Brow Software Engineering
        1. Understand a complex system
        2. Modify the sytem to add a feature
        3. Ship the new system (test well and stuff)
      you make your self chanagences like (fore loop challenge)[https://www.youtube.com/watch?v=ee1bXLDN60U]. You will get good at this.
      Machine Learning Engineer
        1. Download a paper
        2. Implement it
        3. Keep doing this until you have skills
      What is it you think you can't do
      You guys always say, I wanna learn I wanna learn, like what is it you wanna learn.
      If you care about.
      Are you leaning something from nature / object?
      Are you learning something form people / meta?
      like Data science:
        means statistics / stats -> good
        tool used at company x -> no    yes for benifing people
        like freamwork, tooling that will go out of vogue -> no
      Wanna build a knowleged tree
      lot less shaped by programmers, doing the ground work and a lot of shaped by who's talking the best storyes. 
      that's all's gonna be in future, I talk to customer and I give it to the engineers
      1:15:00

0 to production
    simplify, what the thing actually is


Everyone is just try to capture value.
...
(availability of the knowledge, the output) (faster work)

# Economy Business
বিভিন্ন ফাইন্যান্সিয়াল থিওরি গভীরে না বুঝলে আপনি পরীক্ষায় এ গ্রেড পেতে পারবেন না। আবার আপনি যদি সবকিছু পরিষ্কার বুঝে থাকেন এবং চর্চা করেন, তাহলে কোন কিছু মুখস্ত না করেই ভালো ফলাফল অর্জন করতে পারবেন। 

সাধারণত একাডেমিক বই পড়তে আমার একঘেয়ে লাগতো কিন্তু অর্থনীতির বিদেশী একাডেমিক বই গুলো অসাধারন। আমি দুইটা বই বিশেষ পছন্দ করেছি। ১ – ম্যানকিউ এবং ২ – বেন বার্নানকি (পরবর্তীতে তিনি ফেডারেল রিজার্ভের চেয়ারম্যান হন)। - greg mankiw and Ben Shalom Bernanke

কোন বিদেশী বই পেলেই হাতে নিয়ে পড়ে দেখতাম। কিছু না বুঝলে জিদ চেপে বসতো। তাই আরও পড়া শুরু করলাম। কেমব্রিজের এ লেভেলের বই থেকে শুরু করে ধীরে ধীরে আরও জটিলতোর ফাইন্যান্সের বইয়ের দিকে ঝোঁক বাড়তে থাকলো। দেখা গেল কোন বই না বুঝলে এর আগে কী কী বই পড়তে হবে তা টার্গেট করে নতুন নতুন বই খুঁজে পড়া শুরু করতাম।

যেদিন থেকে পড়াশোনার আনন্দ পেয়েছি সেদিন থেকে বিশ্ববিদ্যালয়ের পরীক্ষার জন্য পড়া ছেড়ে দিয়েছি প্রায়। এমন আরও কত কিছু ত্যাগ করে যে জ্ঞানের নেশায় বুদ হয়ে ছিলাম তার কোন হিসেব নেই।  কেবল বিরক্তিকর কিছু মুখস্তভিত্তিক বিষয় এবং তেল খাওয়া শিক্ষকের শিক্ষিকার জন্য গ্রেড একটু পিছিয়ে যায়। অনেক বঞ্চনার শিকার হয়েছি। কিন্তু আমার কোন আফসোস নেই।

আমাকে যদি আবারো বিশ্ববিদ্যালয়ে পাঠানো হয়। আমি আবার একই কাজ করতে চাই। কারণ সেটাই সঠিক।

নিজের জ্ঞান অর্জনের রাস্তা নিজেকেই তৈরি করতে হয়. আপনারা যারা শিখতে চান এই রাস্তা ধরুন। নিজেই নিজের শিক্ষক হয়ে যান। বই, পত্রিকা, ভিডিও এবং নিজের চিন্তা থেকে শিখুন। কেউ আপনার জন্য কিছু করবে না। নিজের চেষ্টাতেই নিজেকে সামনে আগাতে হবে। 

period today - 12 Jan 2026
